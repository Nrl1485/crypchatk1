...
// const path = require('path'); // Path Dihapus karena Routing HTML ditangani oleh vercel.json
const app = express();
...
// PENTING: Semua routing file statis dihapus agar tidak bentrok dengan vercel.json
...
// 1. Root Endpoint (Khusus menampilkan Status Server, akan di-rewrite oleh vercel.json)
app.get('/', (req, res) => {
    // Pesan ini hanya muncul jika vercel.json GAGAL me-rewrite ke index.html
