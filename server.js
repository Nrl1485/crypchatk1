...
const path = require('path'); // Wajib: Untuk mengelola path file statis
const app = express();
...
// 1. Root Endpoint (Menyajikan Status Server)
// Kita buat route '/' untuk menampilkan pesan status (Backend is running)
app.get('/', (req, res) => {
    res.status(200).send('CrypChat Backend Server is running on Vercel.');
});


// 2. Frontend Endpoint (Menyajikan index.html)
// Kita buat route /app untuk memastikan index.html dimuat tanpa bentrok
app.get('/app', (req, res) => {
